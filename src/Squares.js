    ...
    return (
      <div style={{height: '50vh'}}>
        <div style={{height: '100%', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
          ...
          <h1 style={{color: 'black', fontSize: '3em', fontFamily: 'Roboto', marginTop: '0.4em', marginBottom: '0.4em'}}>{this.props.content}</h1>
          <h2 style={{color: 'grey', fontWeight: '400', fontFamily: 'Roboto', margin: 0}}>{this.props.content2}</h2>
        </div>
